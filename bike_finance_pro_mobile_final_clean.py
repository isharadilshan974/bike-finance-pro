...
/* FINAL CONTRAST / MOBILE / TABLE FIX */
.stApp .customer-chip{
...
.stApp button[data-testid="baseButton-primary"] *{
    background:#07111f!important;color:#fff!important;-webkit-text-fill-color:#fff!important;
    border:1px solid #0b1f33!important;opacity:1!important;
}
...
.stApp [data-testid="stButton"] > button:not([kind="primary"]) *{
    ...
    border:1px solid #d0d5dd!important;opacity:1!important;
}
.stApp [data-testid="stDownloadButton"] > button,
.stApp [data-testid="stDownloadButton"] > button *{
    background:#07111f!important;color:#fff!important;-webkit-text-fill-color:#fff!important;
    border:1px solid #172a40!important;opacity:1!important;
}
...
.stApp [data-baseweb="tab"][aria-selected="true"] *{
    color:#fff!important;-webkit-text-fill-color:#fff!important;background:#07111f!important;
}
.mobile-table-wrap{
    width:100%;box-sizing:border-box;background:#fff;border:1px solid #dfe5eb;
    border-radius:18px;overflow:hidden;margin:10px 0 16px;
    box-shadow:0 10px 25px rgba(7,17,31,.07);
}
.mobile-table-title{
    padding:12px 14px;font-size:12px;font-weight:900;color:#101828!important;
...
.mobile-finance-table{
    ...
    font-family:Inter,Arial,sans-serif;background:#fff!important;color:#101828!important;
}
.mobile-finance-table th{
    background:#07111f!important;color:#fff!important;-webkit-text-fill-color:#fff!important;
    font-size:10px;font-weight:900;text-align:right;padding:11px 10px;
    white-space:nowrap;border-right:1px solid #24354a;
}
.mobile-finance-table th:first-child{text-align:center}
.mobile-finance-table td{
    background:#fff!important;color:#101828!important;-webkit-text-fill-color:#101828!important;
    font-size:10px;padding:10px;white-space:nowrap;text-align:right;
    border-right:1px solid #e5e7eb;border-bottom:1px solid #e5e7eb;
}
.mobile-finance-table td:first-child{
    text-align:center;font-weight:800;background:#f8fafc!important;
}
.mobile-finance-table tbody tr:nth-child(even) td{background:#f8fafc!important}

@media(max-width:700px){
    .block-container{width:100%!important;max-width:100%!important;padding:8px 10px 28px!important}
    ...
    .customer-chip{color:#fff!important;-webkit-text-fill-color:#fff!important;background:#07111f!important}
    .stButton>button[kind="primary"],.stButton>button[kind="primary"] *{
        color:#fff!important;-webkit-text-fill-color:#fff!important;background:#07111f!important;
    }
    .stButton>button:not([kind="primary"]),.stButton>button:not([kind="primary"]) *{
        color:#101828!important;-webkit-text-fill-color:#101828!important;background:#fff!important;
    }
    ...
    [data-baseweb="tab-list"]{
        ...
        gap:6px!important;scrollbar-width:none!important;padding-bottom:4px!important;
    }
    [data-baseweb="tab-list"]::-webkit-scrollbar{display:none!important}
    [data-baseweb="tab"]{
        flex:0 0 auto!important;min-height:44px!important;padding:10px 12px!important;
        font-size:10px!important;white-space:nowrap!important;
    }
    .mobile-table-wrap{border-radius:16px!important}
    .mobile-finance-table{min-width:620px!important}
    .mobile-finance-table th,.mobile-finance-table td{font-size:10px!important;padding:10px 9px!important}
    .hero,.hero *{color:#fff!important;-webkit-text-fill-color:#fff!important}
    .hero .hero-sub{color:#d9e5ef!important;-webkit-text-fill-color:#d9e5ef!important}
    .finance-box,.finance-box *{color:#101828!important;-webkit-text-fill-color:#101828!important}
    .finance-box .finance-sub,.finance-box .finance-status,.finance-box .finance-row span{
        color:#667085!important;-webkit-text-fill-color:#667085!important
    }
    .offer-card,.offer-card *,.total-card,.total-card *{
        color:#fff!important;-webkit-text-fill-color:#fff!important
    }
    .offer-card .offer-sub,.offer-card .offer-pill small,.total-card .total-label,.total-card .total-detail{
        color:#c9d6e1!important;-webkit-text-fill-color:#c9d6e1!important
    }
}
...
def display_finance_table(df, table_title=""):
    """Responsive finance table for desktop and mobile."""
    import html as _html
    safe = df.copy()
    headers = "".join(
        f"<th>{_html.escape(str(col))}</th>" for col in safe.columns
    )
    rows = []
    for _, row in safe.iterrows():
        cells = "".join(
            f"<td>{_html.escape(str(value))}</td>" for value in row.tolist()
        )
        rows.append(f"<tr>{cells}</tr>")
    title = (
        f'<div class="mobile-table-title">{_html.escape(table_title)}</div>'
        if table_title else ""
    )
    html = f"""
    <div class="mobile-table-wrap">
        ...
        <div class="mobile-table-scroll">
            <table class="mobile-finance-table">
...
""",
    ...
    display_finance_table(
        customer_combined,
        "Customer Combined Payment Plan"
    )
